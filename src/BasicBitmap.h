...
#elif defined(_WIN64) || defined(WIN64) || defined(__amd64__) || defined(__x86_64) || defined(__x86_64__) || defined(_M_IA64) || defined(_M_AMD64)
...
#endif
#ifndef IWORDS_BIG_ENDIAN
#if defined(__hppa__) || defined(__m68k__) || defined(mc68000) || defined(_M_M68K) || (defined(__MIPS__) && defined(__MISPEB__)) || defined(__ppc__) || defined(__POWERPC__) || defined(_M_PPC) || defined(__sparc__) || defined(__powerpc__) || defined(__mc68000__) || defined(__s390x__) || defined(__s390__)
#define IWORDS_BIG_ENDIAN 1
#endif
#endif
#ifndef IWORDS_BIG_ENDIAN
...
#define _pixel_fetch_24_lsb(ptr, offset) \
    ((((IUINT32)(((const IUINT8*)(ptr)) + (offset)*3)[0]) << 0) | (((IUINT32)(((const IUINT8*)(ptr)) + (offset)*3)[1]) << 8) | (((IUINT32)(((const IUINT8*)(ptr)) + (offset)*3)[2]) << 16))

#define _pixel_fetch_24_msb(ptr, offset) \
    ((((IUINT32)(((const IUINT8*)(ptr)) + (offset)*3)[0]) << 16) | (((IUINT32)(((const IUINT8*)(ptr)) + (offset)*3)[1]) << 8) | (((IUINT32)(((const IUINT8*)(ptr)) + (offset)*3)[2]) << 0))
...
#define _pixel_store_24_lsb(ptr, off, c)                              \
    do {                                                              \
...
#define _pixel_store_24_msb(ptr, off, c)                              \
    do {                                                              \
...
#define _pixel_load_card_lsb(ptr, r, g, b, a) \
    do {                                      \
        (a) = ((IUINT8*)(ptr))[3];            \
        (r) = ((IUINT8*)(ptr))[2];            \
        (g) = ((IUINT8*)(ptr))[1];            \
...
#define _pixel_load_card_msb(ptr, r, g, b, a) \
    do {                                      \
        (a) = ((IUINT8*)(ptr))[0];            \
        (r) = ((IUINT8*)(ptr))[1];            \
        (g) = ((IUINT8*)(ptr))[2];            \
...
#define _pixel_save_card_lsb(ptr, r, g, b, a) \
    do {                                      \
...
#define _pixel_save_card_msb(ptr, r, g, b, a) \
    do {                                      \
...
#define _pixel_read_24_lsb(a) \
    ((((IUINT32)(((const unsigned char*)(a))[0]))) | (((IUINT32)(((const unsigned char*)(a))[1])) << 8) | (((IUINT32)(((const unsigned char*)(a))[2])) << 16))

#define _pixel_read_24_msb(a) \
    ((((IUINT32)(((const unsigned char*)(a))[0])) << 16) | (((IUINT32)(((const unsigned char*)(a))[1])) << 8) | (((IUINT32)(((const unsigned char*)(a))[2]))))

#define _pixel_write_24_lsb(a, c)                                \
    do {                                                         \
...
#define _pixel_write_24_msb(a, c)                                \
    do {                                                         \
...
#define _pixel_to_gray(r, g, b) ((19595 * (r) + 38469 * (g) + 7472 * (b)) >> 16)
...
/* assembly 32 bits */
#define _pixel_asm_8888(a, b, c, d) \
    ((IUINT32)(((IUINT32)(a) << 24) | ((IUINT32)(b) << 16) | ((IUINT32)(c) << 8) | ((IUINT32)(d) << 0)))

/* assembly 24 bits */
#define _pixel_asm_888(a, b, c) \
    ((IUINT32)(((IUINT32)(a) << 16) | ((IUINT32)(b) << 8) | ((IUINT32)(c) << 0)))

/* assembly 16 bits */
#define _pixel_asm_1555(a, b, c, d) \
    ((IUINT16)(((IUINT16)((a)&0x80) << 8) | ((IUINT16)((b)&0xf8) << 7) | ((IUINT16)((c)&0xf8) << 2) | ((IUINT16)((d)&0xf8) >> 3)))

#define _pixel_asm_5551(a, b, c, d) \
    ((IUINT16)(((IUINT16)((a)&0xf8) << 8) | ((IUINT16)((b)&0xf8) << 3) | ((IUINT16)((c)&0xf8) >> 2) | ((IUINT16)((d)&0x80) >> 7)))

#define _pixel_asm_565(a, b, c) \
    ((IUINT16)(((IUINT16)((a)&0xf8) << 8) | ((IUINT16)((b)&0xfc) << 3) | ((IUINT16)((c)&0xf8) >> 3)))

#define _pixel_asm_4444(a, b, c, d) \
    ((IUINT16)(((IUINT16)((a)&0xf0) << 8) | ((IUINT16)((b)&0xf0) << 4) | ((IUINT16)((c)&0xf0) << 0) | ((IUINT16)((d)&0xf0) >> 4)))

/* disassembly 32 bits */
#define _pixel_disasm_8888(x, a, b, c, d) \
    do {                                  \
        (a) = ((x) >> 24) & 0xff;         \
        (b) = ((x) >> 16) & 0xff;         \
        (c) = ((x) >> 8) & 0xff;          \
...
#define _pixel_disasm_888X(x, a, b, c) \
    do {                               \
        (a) = ((x) >> 24) & 0xff;      \
        (b) = ((x) >> 16) & 0xff;      \
        (c) = ((x) >> 8) & 0xff;       \
...
#define _pixel_disasm_X888(x, a, b, c) \
    do {                               \
        (a) = ((x) >> 16) & 0xff;      \
        (b) = ((x) >> 8) & 0xff;       \
        (c) = ((x) >> 0) & 0xff;       \
...
/* disassembly 24 bits */
#define _pixel_disasm_888(x, a, b, c) \
    do {                              \
        (a) = ((x) >> 16) & 0xff;     \
        (b) = ((x) >> 8) & 0xff;      \
        (c) = ((x) >> 0) & 0xff;      \
...
/* disassembly 16 bits */
#define _pixel_disasm_1555(x, a, b, c, d)         \
    do {                                          \
...
#define _pixel_disasm_X555(x, a, b, c)            \
    do {                                          \
...
#define _pixel_disasm_5551(x, a, b, c, d)         \
    do {                                          \
...
#define _pixel_disasm_555X(x, a, b, c)            \
    do {                                          \
        (a) = _pixel_scale_5[((x) >> 11) & 0x1f]; \
        (b) = _pixel_scale_5[((x) >> 6) & 0x1f];  \
        (c) = _pixel_scale_5[((x) >> 1) & 0x1f];  \
...
#define _pixel_disasm_565(x, a, b, c)             \
    do {                                          \
        (a) = _pixel_scale_5[((x) >> 11) & 0x1f]; \
...
#define _pixel_disasm_4444(x, a, b, c, d)        \
    do {                                         \
...
#define _pixel_disasm_X444(x, a, b, c)          \
    do {                                        \
...
#define _pixel_disasm_444X(x, a, b, c)           \
    do {                                         \
        (a) = _pixel_scale_4[((x) >> 12) & 0xf]; \
        (b) = _pixel_scale_4[((x) >> 8) & 0xf];  \
        (c) = _pixel_scale_4[((x) >> 4) & 0xf];  \
...
#define ILINS_LOOP_DOUBLE(actionx1, actionx2, width)    \
    do {                                                \
...
public:
    ...
    // (mode & PIXEL_FLAG_MASK) != 0, for transparent bliting (using SetMask to
    // set color key) returns zero for successful, others for error
    int Blit(int x, int y, const BasicBitmap* src, int sx, int sy, int w, int h,
        int mode = 0);
    int Blit(int x, int y, const BasicBitmap* src, const BasicRect* rect = NULL,
        int mode = 0);
    ...
    int Convert(int x, int y, const BasicBitmap* src, int sx, int sy, int w,
        int h, int mode = 0);
    ...
    int Blend(int x, int y, const BasicBitmap* src, int sx, int sy, int w,
        int h, int mode = 0, IUINT32 color = 0xffffffff);

    // split r, g, b, a channels
    int SplitChannel(BasicBitmap* R, BasicBitmap* G, BasicBitmap* B,
        BasicBitmap* A);
    ...
    // color (when using PIXEL_FLAG_MASK), mode can be PIXEL_FLAG_MASK / HFLIP /
    // VFLIP
    void BresenhamStretch(int dx, int dy, int dw, int dh,
        const BasicBitmap* src, int sx, int sy, int sw,
        int sh, int mode);

    // Get A8R8G8B8 from position, different from GetPixel, GetPixel returns raw
    // pixel GetColor will convert raw pixel to A8R8G8B8
    IUINT32 GetColor(int x, int y) const;

    // Set A8R8G8B8 to position, SetPixel set raw pixel, GetColor will convert
    // A8R8G8B8 to raw pixel format then set to position
...
public:
    ...
    inline const IUINT16* Address16(int x, int y) const
    {
        return ((const IUINT16*)Line(y)) + x;
    }
    inline const IUINT32* Address32(int x, int y) const
    {
        return ((const IUINT32*)Line(y)) + x;
    }
    inline const IUINT8* Address24(int x, int y) const
    {
        return Line(y) + x * 3;
    }
...
public:
    ...
    void Scale(int dx, int dy, int dw, int dh, const BasicBitmap* src, int sx,
        int sy, int sw, int sh, int mode = 0,
        IUINT32 color = 0xffffffff);

    void Scale(const BasicRect* rect, const BasicBitmap* src,
        const BasicRect* bound, int mode = 0,
        IUINT32 color = 0xffffffff);
    ...
    void DrawGlyph(int x, int y, const void* glyph, int w, int h,
        IUINT32 color);
    ...
    int Resample(int dx, int dy, int dw, int dh, const BasicBitmap* src, int sx,
        int sy, int sw, int sh, ResampleFilter filter);

    // return an new resampled bitmap
    BasicBitmap* Resample(int NewWidth, int NewHeight,
        ResampleFilter filter) const;

public:
    typedef int (*PixelBlit)(void* dst, long dpitch, int dx, const void* src,
        long spitch, int sx, int w, int h, IUINT32 mask,
        int flip);
    ...
    typedef int (*InterpRow)(IUINT32* card, int w, const IUINT32* row1,
        const IUINT32* row2,
        IINT32 fraction); // 15.16 fixed point

    typedef int (*InterpCol)(IUINT32* card, int w, const IUINT32* src, IINT32 x,
        IINT32 dx); // 15.16 fixed point
...
public:
    static BasicBitmap* LoadBmpFromMemory(const void* buffer, long size,
        BasicColor* pal);

    static BasicBitmap* LoadTgaFromMemory(const void* buffer, long size,
        BasicColor* pal);

    static BasicBitmap* LoadBmp(const char* filename, PixelFmt fmt = UNKNOW,
        BasicColor* pal = NULL);

    static BasicBitmap* LoadTga(const char* filename, PixelFmt fmt = UNKNOW,
        BasicColor* pal = NULL);
    ...
    // Search Palette
    static int BestfitColor(const BasicColor* pal, int r, int g, int b,
        int size);

    // DownSample 2x2 pixels into 1 pixel, only support 8/32 bits
    int DownSampleBy2(int x, int y, const BasicBitmap* src, int sx, int sy,
        int sw, int sh);
...
public:
    ...
    // draw to hdc
    int SetDIBitsToDevice(void* hDC, int x, int y, int sx, int sy, int sw,
        int sh);
    ...
    static void* GdiPlusLoadCore(const void* data, long size, int* cx, int* cy,
        long* pitch, int* pfmt, int* bpp,
        int* errcode);

    // load image using gdi plus, make sure gdi+ has been initialized
    // call GdiPlusInit first if you need
    static BasicBitmap* GdiPlusLoadImageFromMemory(const void* data, long size,
        int* err);

    // load image using gdi plus, make sure gdi+ has been initialized
    // call GdiPlusInit first if you need
    static BasicBitmap* GdiPlusLoadImage(const char* filename,
        PixelFmt fmt = UNKNOW);

    // CreateDIBSection and then create BasicBitmap in the DIB (borror pixel
    // memory) DeleteObject((HBITMAP)hbitmap) must be invoked to dispose DIB
    // after bitmap destruction
    static BasicBitmap* CreateBitmapInDIB(void* hDC, int w, int h, PixelFmt fmt,
        void** hbitmap);
    ...
    // detect file type, and using LoadBmpFromMemory,
    // GdiPlusLoadImageFromMemory, ..
    static BasicBitmap* LoadImageFromMemory(const void* data, long size,
        BasicColor* pal);

    // detect file type and load
    static BasicBitmap* LoadFile(const char* filename, PixelFmt fmt = UNKNOW,
        BasicColor* pal = NULL);
...
protected:
    ...
    static void Fetch(PixelFmt fmt, const void* bits, int x, int w,
        IUINT32* buffer);
    static void Store(PixelFmt fmt, void* bits, int x, int w,
